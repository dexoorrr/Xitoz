...
border-radius:8px;
background:
linear-gradient(#78a84d,#547d34);
color:white;
font-weight:bold;
cursor:pointer;
box-shadow:0 3px #354e25;
}
...
.xv-danger{
background:
linear-gradient(#a75b51,#753c36);
box-shadow:0 3px #4e2925;
}
...
options:{
simulateErrors:
Boolean(body.simulateErrors),

variation:
Boolean(body.variation)
},
...
/*
   Opcionalmente removemos jobs
   concluídos depois de alguns segundos.
*/
